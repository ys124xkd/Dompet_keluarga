 ...
 * Use the [EditProfileFragment_user.newInstance] factory method to
 * create an instance of this fragment.
 */
class EditProfileFragment_user : Fragment() {
    ...
    override fun onCreateView(
        ...
        profileImageView = binding.circleImageView
        nameTextView = binding.TextNama
        emailTextView = binding.TextEmail
        ...
        binding.back.setOnClickListener {
            findNavController().navigate(R.id.action_editProfileFragment_user_to_homeFragment_user2)
        }
        return binding.root
    }
    ...
    private fun fetchUserProfile() {
        ...
        currentUser?.let { user ->
            firebaseRef.child(user.uid).get().addOnSuccessListener { dataSnapshot ->
                ...
                emailTextView.text = email ?: "Email not set"
                profileImageUrl?.let {
